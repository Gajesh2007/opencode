export const dict = {
  ...
  "command.model.reasoning.pro.enable": "Enable Pro reasoning",
  "command.model.reasoning.pro.disable": "Disable Pro reasoning",
  "command.model.reasoning.pro.description": "Use GPT-5.6 Pro mode with higher latency and token usage",
